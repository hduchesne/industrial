...
<c:set var="lastContentsStatement" value="select * from [tint:content] as contents where ISDESCENDANTNODE(contents,'${currentNode.resolveSite.path}') ${queryConstraint} order by contents.[date] desc"/>
